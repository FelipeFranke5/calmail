...
public class AIResponseControllerTest {
    ...
    void getResponseById_ReturnsOk_WithAIResponse() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/responses/generated/{id}", id)
                ...
                .andDo(document(
                        ...
                        responseFields(
                                ...
                                fieldWithPath("request.protocolDeadlineInDays")
                                        .description("Prazo para o protocolo ser resolvido. Formato: Number ou Null."),
                        ...
                        requestHeaders(headerWithName("Authorization")
                                .description("Token de autenticação. Formato: Bearer token. Obrigatório: Sim.")),
                        links(
                                ...
                                linkWithRel("list").description("Link para listar todas as respostas (Sem ordenação)."),
    ...
    void getResponseById_When_ServiceThrowsAIResponseNotFoundException_ReturnsNotFound() throws Exception {
        UUID id = UUID.randomUUID();
    ...
    void getResponseById_When_IdIsNotValid_ReturnsBadRequest() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/responses/generated/{id}", invalidId)
