...
public class AIResponseFileWriterTest {
  ...
  @InjectMocks private AIResponseFileWriter aiResponseFileWriter;
  ...
  public static void tearDownAfterAll() {
    ...
    logger.info(
        "Duration in seconds: " + Duration.between(beforeAllInstant, afterAllInstant).toSeconds());
    logger.info(
        "Duration in milis: " + Duration.between(beforeAllInstant, afterAllInstant).toMillis());
