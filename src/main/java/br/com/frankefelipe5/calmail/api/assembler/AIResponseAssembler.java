...
public class AIResponseAssembler implements RepresentationModelAssembler<AIResponse, AIResponseDTO> {
    ...
    public AIResponseDTO toModel(AIResponse entity) {
        ...
        AIResponseDTO responseDTO =
                new AIResponseDTO(entity.getId(), entity.getResponseText(), entity.getRequest(), entity.getCreatedAt());
        responseDTO.add(linkTo(methodOn(AIResponseController.class).getResponseById(entity.getId()))
                .withSelfRel());
        responseDTO.add(linkTo(methodOn(AIResponseController.class).deleteResponseById(entity.getId()))
                .withRel("delete"));
        responseDTO.add(linkTo(methodOn(AIResponseController.class).listResponses("false"))
                .withRel("list"));
        responseDTO.add(linkTo(methodOn(AIResponseController.class).listResponses("true"))
                .withRel("list-order"));
        responseDTO.add(linkTo(methodOn(AIResponseController.class).createScript(requestExample))
                .withRel("create"));
