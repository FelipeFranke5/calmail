...
public record Request(String name, Boolean recurrent, Boolean hasProtocol, Integer protocolDeadlineInDays,
        String protocolStatus, String message) {
    public Request {
    ...
    public Request(Boolean hasProtocol, Integer protocolDeadlineInDays, String protocolStatus, String message) {
    ...
    public Request(Boolean recurrent, Boolean hasProtocol, Integer protocolDeadlineInDays, String message) {
        this(null, recurrent, hasProtocol, protocolDeadlineInDays, null, message);
    }

    public Request(Boolean recurrent, Boolean hasProtocol, Integer protocolDeadlineInDays, String protocolStatus,
            String message) {
    ...
    private void validateHasProtocolWithRequiredArgs(Boolean hasProtocol, Integer protocolDeadlineInDays,
            String protocolStatus) {
        if ((hasProtocol == true) && (protocolDeadlineInDays == null || protocolStatus == null)) {
            throw new RequestException("the fields protocolDeadlineInDays and protocolStatus are mandatory");
        }
    ...
    private void validateDeadline(Integer protocolDeadlineInDays) {
        if ((protocolDeadlineInDays != null) && (protocolDeadlineInDays < 3 || protocolDeadlineInDays > 7)) {
