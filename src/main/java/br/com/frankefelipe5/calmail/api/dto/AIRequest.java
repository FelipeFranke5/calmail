...
public record AIRequest(
    ...
    public AIRequest(Boolean hasProtocol, Integer protocolDeadlineInDays, String protocolStatus, String message) {
    ...
    public AIRequest(Boolean recurrent, Boolean hasProtocol, Integer protocolDeadlineInDays, String message) {
