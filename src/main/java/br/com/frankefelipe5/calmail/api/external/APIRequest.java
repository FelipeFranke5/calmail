...
public class APIRequest {
    ...
    public APIRequest(Request request, OpenAiChatModel chatModel, AIResponseRepository aiResponseRepository) {
    ...
    public Message getUserMessage() {
        ...
        if (requestData.isBlank() || requestData.isEmpty()) throw new APIRequestException("request data cannot be empty");
    ...
    public Message getSystemMessage() {
        ...
        if (systemRoleMessage.isBlank() || systemRoleMessage.isEmpty()) throw new APIRequestException(
